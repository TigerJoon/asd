      ...
      <table class="table" border="1">
         ...
         <tbody>
            ...
            <tr>
               ...
               <!-- 좋아요 영역 시작 -->
               <td>
                  <!--  부트스트랩 현재상영중 박스처리 --> <strong>${vo.mname}</strong> <span
                  class="badge text-bg-success">현재상영중</span>
                  <button id="likebtn" class="badge text-bg-success">좋아요</button><a id="heart" style="font-size: 20px;"></a>
   ...
   <div class="row mb-3">
      <form action="moviecomminsert" method="post">
         ...
         <div class="col-sm-10">
            ...
            <table>
               <tr>
                  <td>작성자: ${sessionScope.sessionID}</td>
            ...
            <div class="mb-3" id="myform1">
               ...
               <input type="radio" name="mgood" value=1 id="mgood"> <label
                  ...
                  id="mgood"> <label for="rate2">★★</label> <input
                  type="radio" name="mgood" value=3 id="mgood"> <label
                  for="rate3">★★★</label> <input type="radio" name="mgood" value=4
                  id="mgood"> <label for="rate4">★★★★</label> <input
   ...
   $(function() {   
      ...
      $('#likebtn').click(function() {
         $.ajax({
               ...
               success : function(jsondata){
                  console.log('무준아 클릭');
                  console.log("클릭 jsondata=> "+jsondata);
                  if(jsondata===0){
                     $('#heart').html('♡');
                  }else{
                     $('#heart').html('♥');
