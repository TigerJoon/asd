...
<c:forEach var="e" items="${list}">
  ...
  <img class="card-img-top" src="${pageContext.request.contextPath}/resources/imgfiles/${e.popimg}" 
...
// javascript를 json문자로 변환 하는 함수
// Save cart  
function saveCart() {
	// sessionStorage에 저장된 아이템을 저장함
 sessionStorage.setItem('shoppingCart', JSON.stringify(cart));
}

 // json을 javascript로 변환하는 함수
 // Load cart  
function loadCart() {
	 // sessionStorage에 저장된 아이템을 불러옴
 cart = JSON.parse(sessionStorage.getItem('shoppingCart'));
}
 // shoppingCart에 값이 있으면 loadCart 함수를 부름
